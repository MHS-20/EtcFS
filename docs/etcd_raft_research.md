...
2. [etcd MVCC & Storage](https://etcd.io/docs/v3.5/learning/design/)
...
5. [etcd Leases](https://etcd.io/docs/v3.5/learning/api/#lease-service)
6. [etcd Watches](https://etcd.io/docs/v3.5/learning/api/#watch-service)
...
11. [JuiceFS Metadata Engine Comparison](https://juicefs.com/docs/community/metadata_engines/)
